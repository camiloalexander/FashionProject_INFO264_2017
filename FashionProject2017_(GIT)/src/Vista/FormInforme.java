...
public class FormInforme extends javax.swing.JFrame {
    ...
    private void opcionesdeTrabajadores(){
        ...
        for(int j=0; j<lt.size();j++){
                ...
                //cb[j]=new JComboBox(t.getNombre());
                //cb[j].addActionListener(this);
                //add(cb[j]);
                panel.add(cb);
                //buttonGroup1.add(cb);
                panel.updateUI();
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2)
                            .addComponent(generar1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(39, 39, 39)
